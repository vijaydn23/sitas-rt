...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center">
      <div className="p-8 rounded-2xl shadow border max-w-xl w-full text-center space-y-4">
        <h1 className="text-2xl font-semibold">SITAS-NDT</h1>

        {loading ? (
          <div className="p-3 border rounded inline-block">Loading…</div>
        ) : (
          <>
            ...
            <div className="flex gap-3 justify-center flex-wrap">
              {!profile && (
                <>
                  ...
                  <Link href="/auth/sign-up" className="px-4 py-2 rounded border">Sign up</Link>
                </>
              )}
